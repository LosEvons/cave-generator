...
### Aiotut lähteet
- Pitää etsiä lisää, mutta algoritmien kuvaukset etsityissä opetusmateriaaleissa, sekä aikaisemmat toteutukset

### Harjoitustyön ydin
- Proseduraalinen generaatio ja verkkoalgoritmit

### Muuta
- tietojenkäsittelytieteen kandidaatti (TKT)
- Ensisijaisena dokumentaatiokielenä toimii Englanti